 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DO-PROCESSOS-OU-TECNICAS" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DO-PROCESSOS-OU-TECNICAS" minOccurs="0"/>
...
@XmlRootElement(name = "PROCESSOS-OU-TECNICAS")
public class PROCESSOSOUTECNICAS {

    @XmlElement(name = "DADOS-BASICOS-DO-PROCESSOS-OU-TECNICAS")
    protected DADOSBASICOSDOPROCESSOSOUTECNICAS dadosbasicosdoprocessosoutecnicas;
    @XmlElement(name = "DETALHAMENTO-DO-PROCESSOS-OU-TECNICAS")
    protected DETALHAMENTODOPROCESSOSOUTECNICAS detalhamentodoprocessosoutecnicas;
    ...
    /**
     * Obtém o valor da propriedade dadosbasicosdoprocessosoutecnicas.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDOPROCESSOSOUTECNICAS }
     *     
     */
    public DADOSBASICOSDOPROCESSOSOUTECNICAS getDADOSBASICOSDOPROCESSOSOUTECNICAS() {
        return dadosbasicosdoprocessosoutecnicas;
    }

    /**
     * Define o valor da propriedade dadosbasicosdoprocessosoutecnicas.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDOPROCESSOSOUTECNICAS }
     *     
     */
    public void setDADOSBASICOSDOPROCESSOSOUTECNICAS(DADOSBASICOSDOPROCESSOSOUTECNICAS value) {
        this.dadosbasicosdoprocessosoutecnicas = value;
    }

    /**
     * Obtém o valor da propriedade detalhamentodoprocessosoutecnicas.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODOPROCESSOSOUTECNICAS }
     *     
     */
    public DETALHAMENTODOPROCESSOSOUTECNICAS getDETALHAMENTODOPROCESSOSOUTECNICAS() {
        return detalhamentodoprocessosoutecnicas;
    }

    /**
     * Define o valor da propriedade detalhamentodoprocessosoutecnicas.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODOPROCESSOSOUTECNICAS }
     *     
     */
    public void setDETALHAMENTODOPROCESSOSOUTECNICAS(DETALHAMENTODOPROCESSOSOUTECNICAS value) {
        this.detalhamentodoprocessosoutecnicas = value;
    }
