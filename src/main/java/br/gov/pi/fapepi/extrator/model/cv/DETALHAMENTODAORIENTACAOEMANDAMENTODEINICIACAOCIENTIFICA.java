...
@XmlType(name = "")
@XmlRootElement(name = "DETALHAMENTO-DA-ORIENTACAO-EM-ANDAMENTO-DE-INICIACAO-CIENTIFICA")
public class DETALHAMENTODAORIENTACAOEMANDAMENTODEINICIACAOCIENTIFICA {
