 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DE-OUTRA-PRODUCAO-ARTISTICA-CULTURAL" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DE-OUTRA-PRODUCAO-ARTISTICA-CULTURAL" minOccurs="0"/>
...
@XmlRootElement(name = "OUTRA-PRODUCAO-ARTISTICA-CULTURAL")
public class OUTRAPRODUCAOARTISTICACULTURAL {

    @XmlElement(name = "DADOS-BASICOS-DE-OUTRA-PRODUCAO-ARTISTICA-CULTURAL")
    protected DADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL dadosbasicosdeoutraproducaoartisticacultural;
    @XmlElement(name = "DETALHAMENTO-DE-OUTRA-PRODUCAO-ARTISTICA-CULTURAL")
    protected DETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL detalhamentodeoutraproducaoartisticacultural;
    ...
    /**
     * Obtém o valor da propriedade dadosbasicosdeoutraproducaoartisticacultural.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL }
     *     
     */
    public DADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL getDADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL() {
        return dadosbasicosdeoutraproducaoartisticacultural;
    }

    /**
     * Define o valor da propriedade dadosbasicosdeoutraproducaoartisticacultural.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL }
     *     
     */
    public void setDADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL(DADOSBASICOSDEOUTRAPRODUCAOARTISTICACULTURAL value) {
        this.dadosbasicosdeoutraproducaoartisticacultural = value;
    }

    /**
     * Obtém o valor da propriedade detalhamentodeoutraproducaoartisticacultural.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL }
     *     
     */
    public DETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL getDETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL() {
        return detalhamentodeoutraproducaoartisticacultural;
    }

    /**
     * Define o valor da propriedade detalhamentodeoutraproducaoartisticacultural.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL }
     *     
     */
    public void setDETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL(DETALHAMENTODEOUTRAPRODUCAOARTISTICACULTURAL value) {
        this.detalhamentodeoutraproducaoartisticacultural = value;
    }
