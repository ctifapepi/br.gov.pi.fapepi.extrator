 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-APRESENTACAO-DE-TRABALHO" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-APRESENTACAO-DE-TRABALHO" minOccurs="0"/>
...
public class APRESENTACAODETRABALHO {

    @XmlElement(name = "DADOS-BASICOS-DA-APRESENTACAO-DE-TRABALHO")
    protected DADOSBASICOSDAAPRESENTACAODETRABALHO dadosbasicosdaapresentacaodetrabalho;
    @XmlElement(name = "DETALHAMENTO-DA-APRESENTACAO-DE-TRABALHO")
    protected DETALHAMENTODAAPRESENTACAODETRABALHO detalhamentodaapresentacaodetrabalho;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdaapresentacaodetrabalho.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDAAPRESENTACAODETRABALHO }
     *     
     */
    public DADOSBASICOSDAAPRESENTACAODETRABALHO getDADOSBASICOSDAAPRESENTACAODETRABALHO() {
        return dadosbasicosdaapresentacaodetrabalho;
    }

    /**
     * Define o valor da propriedade dadosbasicosdaapresentacaodetrabalho.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDAAPRESENTACAODETRABALHO }
     *     
     */
    public void setDADOSBASICOSDAAPRESENTACAODETRABALHO(DADOSBASICOSDAAPRESENTACAODETRABALHO value) {
        this.dadosbasicosdaapresentacaodetrabalho = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodaapresentacaodetrabalho.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODAAPRESENTACAODETRABALHO }
     *     
     */
    public DETALHAMENTODAAPRESENTACAODETRABALHO getDETALHAMENTODAAPRESENTACAODETRABALHO() {
        return detalhamentodaapresentacaodetrabalho;
    }

    /**
     * Define o valor da propriedade detalhamentodaapresentacaodetrabalho.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODAAPRESENTACAODETRABALHO }
     *     
     */
    public void setDETALHAMENTODAAPRESENTACAODETRABALHO(DETALHAMENTODAAPRESENTACAODETRABALHO value) {
        this.detalhamentodaapresentacaodetrabalho = value;
    }
