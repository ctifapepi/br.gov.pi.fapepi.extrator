 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DE-OUTRAS-ORIENTACOES-EM-ANDAMENTO" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DE-OUTRAS-ORIENTACOES-EM-ANDAMENTO" minOccurs="0"/>
...
@XmlRootElement(name = "OUTRAS-ORIENTACOES-EM-ANDAMENTO")
public class OUTRASORIENTACOESEMANDAMENTO {

    @XmlElement(name = "DADOS-BASICOS-DE-OUTRAS-ORIENTACOES-EM-ANDAMENTO")
    protected DADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO dadosbasicosdeoutrasorientacoesemandamento;
    @XmlElement(name = "DETALHAMENTO-DE-OUTRAS-ORIENTACOES-EM-ANDAMENTO")
    protected DETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO detalhamentodeoutrasorientacoesemandamento;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdeoutrasorientacoesemandamento.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO }
     *     
     */
    public DADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO getDADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO() {
        return dadosbasicosdeoutrasorientacoesemandamento;
    }

    /**
     * Define o valor da propriedade dadosbasicosdeoutrasorientacoesemandamento.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO }
     *     
     */
    public void setDADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO(DADOSBASICOSDEOUTRASORIENTACOESEMANDAMENTO value) {
        this.dadosbasicosdeoutrasorientacoesemandamento = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodeoutrasorientacoesemandamento.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO }
     *     
     */
    public DETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO getDETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO() {
        return detalhamentodeoutrasorientacoesemandamento;
    }

    /**
     * Define o valor da propriedade detalhamentodeoutrasorientacoesemandamento.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO }
     *     
     */
    public void setDETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO(DETALHAMENTODEOUTRASORIENTACOESEMANDAMENTO value) {
        this.detalhamentodeoutrasorientacoesemandamento = value;
    }
