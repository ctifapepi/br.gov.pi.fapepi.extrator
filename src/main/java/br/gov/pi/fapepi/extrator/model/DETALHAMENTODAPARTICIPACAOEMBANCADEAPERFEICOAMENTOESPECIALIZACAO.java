...
@XmlType(name = "")
@XmlRootElement(name = "DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-APERFEICOAMENTO-ESPECIALIZACAO")
public class DETALHAMENTODAPARTICIPACAOEMBANCADEAPERFEICOAMENTOESPECIALIZACAO {
    ...
    /**
     * Obtém o valor da propriedade nomedocandidato.
     * 
     * @return
     *     possible object is
     *     {@link String }
