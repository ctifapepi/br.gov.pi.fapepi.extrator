 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO" minOccurs="0"/>
...
@XmlRootElement(name = "PARTICIPACAO-EM-BANCA-DE-GRADUACAO")
public class PARTICIPACAOEMBANCADEGRADUACAO {

    @XmlElement(name = "DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO")
    protected DADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO dadosbasicosdaparticipacaoembancadegraduacao;
    @XmlElement(name = "DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO")
    protected DETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO detalhamentodaparticipacaoembancadegraduacao;
    ...
    /**
     * Obtém o valor da propriedade dadosbasicosdaparticipacaoembancadegraduacao.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO }
     *     
     */
    public DADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO getDADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO() {
        return dadosbasicosdaparticipacaoembancadegraduacao;
    }

    /**
     * Define o valor da propriedade dadosbasicosdaparticipacaoembancadegraduacao.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO }
     *     
     */
    public void setDADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO(DADOSBASICOSDAPARTICIPACAOEMBANCADEGRADUACAO value) {
        this.dadosbasicosdaparticipacaoembancadegraduacao = value;
    }

    /**
     * Obtém o valor da propriedade detalhamentodaparticipacaoembancadegraduacao.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO }
     *     
     */
    public DETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO getDETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO() {
        return detalhamentodaparticipacaoembancadegraduacao;
    }

    /**
     * Define o valor da propriedade detalhamentodaparticipacaoembancadegraduacao.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO }
     *     
     */
    public void setDETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO(DETALHAMENTODAPARTICIPACAOEMBANCADEGRADUACAO value) {
        this.detalhamentodaparticipacaoembancadegraduacao = value;
    }
