 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DE-MANUTENCAO-DE-OBRA-ARTISTICA" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DE-MANUTENCAO-DE-OBRA-ARTISTICA" minOccurs="0"/>
...
@XmlRootElement(name = "MANUTENCAO-DE-OBRA-ARTISTICA")
public class MANUTENCAODEOBRAARTISTICA {

    @XmlElement(name = "DADOS-BASICOS-DE-MANUTENCAO-DE-OBRA-ARTISTICA")
    protected DADOSBASICOSDEMANUTENCAODEOBRAARTISTICA dadosbasicosdemanutencaodeobraartistica;
    @XmlElement(name = "DETALHAMENTO-DE-MANUTENCAO-DE-OBRA-ARTISTICA")
    protected DETALHAMENTODEMANUTENCAODEOBRAARTISTICA detalhamentodemanutencaodeobraartistica;
    ...
    /**
     * Obtém o valor da propriedade dadosbasicosdemanutencaodeobraartistica.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDEMANUTENCAODEOBRAARTISTICA }
     *     
     */
    public DADOSBASICOSDEMANUTENCAODEOBRAARTISTICA getDADOSBASICOSDEMANUTENCAODEOBRAARTISTICA() {
        return dadosbasicosdemanutencaodeobraartistica;
    }

    /**
     * Define o valor da propriedade dadosbasicosdemanutencaodeobraartistica.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDEMANUTENCAODEOBRAARTISTICA }
     *     
     */
    public void setDADOSBASICOSDEMANUTENCAODEOBRAARTISTICA(DADOSBASICOSDEMANUTENCAODEOBRAARTISTICA value) {
        this.dadosbasicosdemanutencaodeobraartistica = value;
    }

    /**
     * Obtém o valor da propriedade detalhamentodemanutencaodeobraartistica.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODEMANUTENCAODEOBRAARTISTICA }
     *     
     */
    public DETALHAMENTODEMANUTENCAODEOBRAARTISTICA getDETALHAMENTODEMANUTENCAODEOBRAARTISTICA() {
        return detalhamentodemanutencaodeobraartistica;
    }

    /**
     * Define o valor da propriedade detalhamentodemanutencaodeobraartistica.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODEMANUTENCAODEOBRAARTISTICA }
     *     
     */
    public void setDETALHAMENTODEMANUTENCAODEOBRAARTISTICA(DETALHAMENTODEMANUTENCAODEOBRAARTISTICA value) {
        this.detalhamentodemanutencaodeobraartistica = value;
    }
