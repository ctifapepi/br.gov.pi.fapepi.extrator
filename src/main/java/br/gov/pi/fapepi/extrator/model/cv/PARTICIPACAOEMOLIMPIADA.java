 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-PARTICIPACAO-EM-OLIMPIADA" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-PARTICIPACAO-EM-OLIMPIADA" minOccurs="0"/>
...
@XmlRootElement(name = "PARTICIPACAO-EM-OLIMPIADA")
public class PARTICIPACAOEMOLIMPIADA {

    @XmlElement(name = "DADOS-BASICOS-DA-PARTICIPACAO-EM-OLIMPIADA")
    protected DADOSBASICOSDAPARTICIPACAOEMOLIMPIADA dadosbasicosdaparticipacaoemolimpiada;
    @XmlElement(name = "DETALHAMENTO-DA-PARTICIPACAO-EM-OLIMPIADA")
    protected DETALHAMENTODAPARTICIPACAOEMOLIMPIADA detalhamentodaparticipacaoemolimpiada;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdaparticipacaoemolimpiada.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDAPARTICIPACAOEMOLIMPIADA }
     *     
     */
    public DADOSBASICOSDAPARTICIPACAOEMOLIMPIADA getDADOSBASICOSDAPARTICIPACAOEMOLIMPIADA() {
        return dadosbasicosdaparticipacaoemolimpiada;
    }

    /**
     * Define o valor da propriedade dadosbasicosdaparticipacaoemolimpiada.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDAPARTICIPACAOEMOLIMPIADA }
     *     
     */
    public void setDADOSBASICOSDAPARTICIPACAOEMOLIMPIADA(DADOSBASICOSDAPARTICIPACAOEMOLIMPIADA value) {
        this.dadosbasicosdaparticipacaoemolimpiada = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodaparticipacaoemolimpiada.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODAPARTICIPACAOEMOLIMPIADA }
     *     
     */
    public DETALHAMENTODAPARTICIPACAOEMOLIMPIADA getDETALHAMENTODAPARTICIPACAOEMOLIMPIADA() {
        return detalhamentodaparticipacaoemolimpiada;
    }

    /**
     * Define o valor da propriedade detalhamentodaparticipacaoemolimpiada.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODAPARTICIPACAOEMOLIMPIADA }
     *     
     */
    public void setDETALHAMENTODAPARTICIPACAOEMOLIMPIADA(DETALHAMENTODAPARTICIPACAOEMOLIMPIADA value) {
        this.detalhamentodaparticipacaoemolimpiada = value;
    }
