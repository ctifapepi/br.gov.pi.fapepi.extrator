 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-TOPOGRAFIA-DE-CIRCUITO-INTEGRADO" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-TOPOGRAFIA-DE-CIRCUITO-INTEGRADO" minOccurs="0"/>
...
@XmlRootElement(name = "TOPOGRAFIA-DE-CIRCUITO-INTEGRADO")
public class TOPOGRAFIADECIRCUITOINTEGRADO {

    @XmlElement(name = "DADOS-BASICOS-DA-TOPOGRAFIA-DE-CIRCUITO-INTEGRADO")
    protected DADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO dadosbasicosdatopografiadecircuitointegrado;
    @XmlElement(name = "DETALHAMENTO-DA-TOPOGRAFIA-DE-CIRCUITO-INTEGRADO")
    protected DETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO detalhamentodatopografiadecircuitointegrado;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdatopografiadecircuitointegrado.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO }
     *     
     */
    public DADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO getDADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO() {
        return dadosbasicosdatopografiadecircuitointegrado;
    }

    /**
     * Define o valor da propriedade dadosbasicosdatopografiadecircuitointegrado.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO }
     *     
     */
    public void setDADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO(DADOSBASICOSDATOPOGRAFIADECIRCUITOINTEGRADO value) {
        this.dadosbasicosdatopografiadecircuitointegrado = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodatopografiadecircuitointegrado.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO }
     *     
     */
    public DETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO getDETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO() {
        return detalhamentodatopografiadecircuitointegrado;
    }

    /**
     * Define o valor da propriedade detalhamentodatopografiadecircuitointegrado.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO }
     *     
     */
    public void setDETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO(DETALHAMENTODATOPOGRAFIADECIRCUITOINTEGRADO value) {
        this.detalhamentodatopografiadecircuitointegrado = value;
    }
