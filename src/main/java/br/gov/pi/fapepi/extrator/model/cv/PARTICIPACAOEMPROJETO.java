 ...
 *       &lt;sequence>
 *         &lt;element ref="{}PROJETO-DE-PESQUISA" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class PARTICIPACAOEMPROJETO {
    ...
    protected List<PROJETODEPESQUISA> projetodepesquisa;
    ...
    /**
     * Gets the value of the projetodepesquisa property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the projetodepesquisa property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPROJETODEPESQUISA().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PROJETODEPESQUISA }
     * 
     * 
     */
    public List<PROJETODEPESQUISA> getPROJETODEPESQUISA() {
        if (projetodepesquisa == null) {
            projetodepesquisa = new ArrayList<PROJETODEPESQUISA>();
        }
        return this.projetodepesquisa;
    }
