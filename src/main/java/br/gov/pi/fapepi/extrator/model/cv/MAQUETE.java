 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-MAQUETE" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-MAQUETE" minOccurs="0"/>
...
@XmlRootElement(name = "MAQUETE")
public class MAQUETE {

    @XmlElement(name = "DADOS-BASICOS-DA-MAQUETE")
    protected DADOSBASICOSDAMAQUETE dadosbasicosdamaquete;
    @XmlElement(name = "DETALHAMENTO-DA-MAQUETE")
    protected DETALHAMENTODAMAQUETE detalhamentodamaquete;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdamaquete.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDAMAQUETE }
     *     
     */
    public DADOSBASICOSDAMAQUETE getDADOSBASICOSDAMAQUETE() {
        return dadosbasicosdamaquete;
    }

    /**
     * Define o valor da propriedade dadosbasicosdamaquete.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDAMAQUETE }
     *     
     */
    public void setDADOSBASICOSDAMAQUETE(DADOSBASICOSDAMAQUETE value) {
        this.dadosbasicosdamaquete = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodamaquete.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODAMAQUETE }
     *     
     */
    public DETALHAMENTODAMAQUETE getDETALHAMENTODAMAQUETE() {
        return detalhamentodamaquete;
    }

    /**
     * Define o valor da propriedade detalhamentodamaquete.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODAMAQUETE }
     *     
     */
    public void setDETALHAMENTODAMAQUETE(DETALHAMENTODAMAQUETE value) {
        this.detalhamentodamaquete = value;
    }
