...
@XmlType(name = "")
@XmlRootElement(name = "DADOS-BASICOS-DA-ORIENTACAO-EM-ANDAMENTO-DE-INICIACAO-CIENTIFICA")
public class DADOSBASICOSDAORIENTACAOEMANDAMENTODEINICIACAOCIENTIFICA {
