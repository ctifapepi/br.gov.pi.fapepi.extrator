 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-BANCA-JULGADORA-PARA-AVALIACAO-CURSOS" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-BANCA-JULGADORA-PARA-AVALIACAO-CURSOS" minOccurs="0"/>
...
@XmlRootElement(name = "BANCA-JULGADORA-PARA-AVALIACAO-CURSOS")
public class BANCAJULGADORAPARAAVALIACAOCURSOS {

    @XmlElement(name = "DADOS-BASICOS-DA-BANCA-JULGADORA-PARA-AVALIACAO-CURSOS")
    protected DADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS dadosbasicosdabancajulgadoraparaavaliacaocursos;
    @XmlElement(name = "DETALHAMENTO-DA-BANCA-JULGADORA-PARA-AVALIACAO-CURSOS")
    protected DETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS detalhamentodabancajulgadoraparaavaliacaocursos;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdabancajulgadoraparaavaliacaocursos.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS }
     *     
     */
    public DADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS getDADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS() {
        return dadosbasicosdabancajulgadoraparaavaliacaocursos;
    }

    /**
     * Define o valor da propriedade dadosbasicosdabancajulgadoraparaavaliacaocursos.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS }
     *     
     */
    public void setDADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS(DADOSBASICOSDABANCAJULGADORAPARAAVALIACAOCURSOS value) {
        this.dadosbasicosdabancajulgadoraparaavaliacaocursos = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodabancajulgadoraparaavaliacaocursos.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS }
     *     
     */
    public DETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS getDETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS() {
        return detalhamentodabancajulgadoraparaavaliacaocursos;
    }

    /**
     * Define o valor da propriedade detalhamentodabancajulgadoraparaavaliacaocursos.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS }
     *     
     */
    public void setDETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS(DETALHAMENTODABANCAJULGADORAPARAAVALIACAOCURSOS value) {
        this.detalhamentodabancajulgadoraparaavaliacaocursos = value;
    }
