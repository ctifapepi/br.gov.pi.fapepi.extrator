 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-APRESENTACAO-EM-RADIO-OU-TV" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-APRESENTACAO-EM-RADIO-OU-TV" minOccurs="0"/>
...
@XmlRootElement(name = "APRESENTACAO-EM-RADIO-OU-TV")
public class APRESENTACAOEMRADIOOUTV {

    @XmlElement(name = "DADOS-BASICOS-DA-APRESENTACAO-EM-RADIO-OU-TV")
    protected DADOSBASICOSDAAPRESENTACAOEMRADIOOUTV dadosbasicosdaapresentacaoemradiooutv;
    @XmlElement(name = "DETALHAMENTO-DA-APRESENTACAO-EM-RADIO-OU-TV")
    protected DETALHAMENTODAAPRESENTACAOEMRADIOOUTV detalhamentodaapresentacaoemradiooutv;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdaapresentacaoemradiooutv.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDAAPRESENTACAOEMRADIOOUTV }
     *     
     */
    public DADOSBASICOSDAAPRESENTACAOEMRADIOOUTV getDADOSBASICOSDAAPRESENTACAOEMRADIOOUTV() {
        return dadosbasicosdaapresentacaoemradiooutv;
    }

    /**
     * Define o valor da propriedade dadosbasicosdaapresentacaoemradiooutv.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDAAPRESENTACAOEMRADIOOUTV }
     *     
     */
    public void setDADOSBASICOSDAAPRESENTACAOEMRADIOOUTV(DADOSBASICOSDAAPRESENTACAOEMRADIOOUTV value) {
        this.dadosbasicosdaapresentacaoemradiooutv = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodaapresentacaoemradiooutv.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODAAPRESENTACAOEMRADIOOUTV }
     *     
     */
    public DETALHAMENTODAAPRESENTACAOEMRADIOOUTV getDETALHAMENTODAAPRESENTACAOEMRADIOOUTV() {
        return detalhamentodaapresentacaoemradiooutv;
    }

    /**
     * Define o valor da propriedade detalhamentodaapresentacaoemradiooutv.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODAAPRESENTACAOEMRADIOOUTV }
     *     
     */
    public void setDETALHAMENTODAAPRESENTACAOEMRADIOOUTV(DETALHAMENTODAAPRESENTACAOEMRADIOOUTV value) {
        this.detalhamentodaapresentacaoemradiooutv = value;
    }
