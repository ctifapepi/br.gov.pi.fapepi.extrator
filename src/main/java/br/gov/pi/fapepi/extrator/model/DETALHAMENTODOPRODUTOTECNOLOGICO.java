 ...
 *       &lt;attribute name="CIDADE-DO-PRODUTO" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
...
@XmlRootElement(name = "DETALHAMENTO-DO-PRODUTO-TECNOLOGICO")
public class DETALHAMENTODOPRODUTOTECNOLOGICO {
    ...
    @XmlSchemaType(name = "anySimpleType")
    protected String cidadedoproduto;
    ...
    /**
     * Obtém o valor da propriedade cidadedoproduto.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade cidadedoproduto.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCIDADEDOPRODUTO(String value) {
        this.cidadedoproduto = value;
    }
