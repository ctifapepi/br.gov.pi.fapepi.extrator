 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-BANCA" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DE-OUTRAS-PARTICIPACOES-EM-BANCA" minOccurs="0"/>
...
@XmlRootElement(name = "OUTRAS-PARTICIPACOES-EM-BANCA")
public class OUTRASPARTICIPACOESEMBANCA {

    @XmlElement(name = "DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-BANCA")
    protected DADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA dadosbasicosdeoutrasparticipacoesembanca;
    @XmlElement(name = "DETALHAMENTO-DE-OUTRAS-PARTICIPACOES-EM-BANCA")
    protected DETALHAMENTODEOUTRASPARTICIPACOESEMBANCA detalhamentodeoutrasparticipacoesembanca;
    ...
    /**
     * Obtém o valor da propriedade dadosbasicosdeoutrasparticipacoesembanca.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA }
     *     
     */
    public DADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA getDADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA() {
        return dadosbasicosdeoutrasparticipacoesembanca;
    }

    /**
     * Define o valor da propriedade dadosbasicosdeoutrasparticipacoesembanca.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA }
     *     
     */
    public void setDADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA(DADOSBASICOSDEOUTRASPARTICIPACOESEMBANCA value) {
        this.dadosbasicosdeoutrasparticipacoesembanca = value;
    }

    /**
     * Obtém o valor da propriedade detalhamentodeoutrasparticipacoesembanca.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODEOUTRASPARTICIPACOESEMBANCA }
     *     
     */
    public DETALHAMENTODEOUTRASPARTICIPACOESEMBANCA getDETALHAMENTODEOUTRASPARTICIPACOESEMBANCA() {
        return detalhamentodeoutrasparticipacoesembanca;
    }

    /**
     * Define o valor da propriedade detalhamentodeoutrasparticipacoesembanca.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODEOUTRASPARTICIPACOESEMBANCA }
     *     
     */
    public void setDETALHAMENTODEOUTRASPARTICIPACOESEMBANCA(DETALHAMENTODEOUTRASPARTICIPACOESEMBANCA value) {
        this.detalhamentodeoutrasparticipacoesembanca = value;
    }
