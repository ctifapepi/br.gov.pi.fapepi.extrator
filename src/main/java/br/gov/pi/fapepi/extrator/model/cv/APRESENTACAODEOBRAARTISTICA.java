 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DA-APRESENTACAO-DE-OBRA-ARTISTICA" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DA-APRESENTACAO-DE-OBRA-ARTISTICA" minOccurs="0"/>
...
@XmlRootElement(name = "APRESENTACAO-DE-OBRA-ARTISTICA")
public class APRESENTACAODEOBRAARTISTICA {

    @XmlElement(name = "DADOS-BASICOS-DA-APRESENTACAO-DE-OBRA-ARTISTICA")
    protected DADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA dadosbasicosdaapresentacaodeobraartistica;
    @XmlElement(name = "DETALHAMENTO-DA-APRESENTACAO-DE-OBRA-ARTISTICA")
    protected DETALHAMENTODAAPRESENTACAODEOBRAARTISTICA detalhamentodaapresentacaodeobraartistica;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdaapresentacaodeobraartistica.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA }
     *     
     */
    public DADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA getDADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA() {
        return dadosbasicosdaapresentacaodeobraartistica;
    }

    /**
     * Define o valor da propriedade dadosbasicosdaapresentacaodeobraartistica.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA }
     *     
     */
    public void setDADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA(DADOSBASICOSDAAPRESENTACAODEOBRAARTISTICA value) {
        this.dadosbasicosdaapresentacaodeobraartistica = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodaapresentacaodeobraartistica.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODAAPRESENTACAODEOBRAARTISTICA }
     *     
     */
    public DETALHAMENTODAAPRESENTACAODEOBRAARTISTICA getDETALHAMENTODAAPRESENTACAODEOBRAARTISTICA() {
        return detalhamentodaapresentacaodeobraartistica;
    }

    /**
     * Define o valor da propriedade detalhamentodaapresentacaodeobraartistica.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODAAPRESENTACAODEOBRAARTISTICA }
     *     
     */
    public void setDETALHAMENTODAAPRESENTACAODEOBRAARTISTICA(DETALHAMENTODAAPRESENTACAODEOBRAARTISTICA value) {
        this.detalhamentodaapresentacaodeobraartistica = value;
    }
