...
@XmlType(name = "")
@XmlRootElement(name = "DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-APERFEICOAMENTO-ESPECIALIZACAO")
public class DADOSBASICOSDAPARTICIPACAOEMBANCADEAPERFEICOAMENTOESPECIALIZACAO {
