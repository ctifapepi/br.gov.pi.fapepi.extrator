 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS" minOccurs="0"/>
...
@XmlRootElement(name = "OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS")
public class OUTRASPARTICIPACOESEMEVENTOSCONGRESSOS {

    @XmlElement(name = "DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS")
    protected DADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS dadosbasicosdeoutrasparticipacoesemeventoscongressos;
    @XmlElement(name = "DETALHAMENTO-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS")
    protected DETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS detalhamentodeoutrasparticipacoesemeventoscongressos;
    ...
    /**
     * Obt�m o valor da propriedade dadosbasicosdeoutrasparticipacoesemeventoscongressos.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS }
     *     
     */
    public DADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS getDADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS() {
        return dadosbasicosdeoutrasparticipacoesemeventoscongressos;
    }

    /**
     * Define o valor da propriedade dadosbasicosdeoutrasparticipacoesemeventoscongressos.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS }
     *     
     */
    public void setDADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS(DADOSBASICOSDEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS value) {
        this.dadosbasicosdeoutrasparticipacoesemeventoscongressos = value;
    }

    /**
     * Obt�m o valor da propriedade detalhamentodeoutrasparticipacoesemeventoscongressos.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS }
     *     
     */
    public DETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS getDETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS() {
        return detalhamentodeoutrasparticipacoesemeventoscongressos;
    }

    /**
     * Define o valor da propriedade detalhamentodeoutrasparticipacoesemeventoscongressos.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS }
     *     
     */
    public void setDETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS(DETALHAMENTODEOUTRASPARTICIPACOESEMEVENTOSCONGRESSOS value) {
        this.detalhamentodeoutrasparticipacoesemeventoscongressos = value;
    }
