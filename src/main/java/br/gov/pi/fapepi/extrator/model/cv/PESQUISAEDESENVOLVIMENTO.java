 ...
 *       &lt;sequence>
 *         &lt;element ref="{}LINHA-DE-PESQUISA" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class PESQUISAEDESENVOLVIMENTO {
    ...
    protected List<LINHADEPESQUISA> linhadepesquisa;
    ...
    /**
     * Gets the value of the linhadepesquisa property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the linhadepesquisa property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLINHADEPESQUISA().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LINHADEPESQUISA }
     * 
     * 
     */
    public List<LINHADEPESQUISA> getLINHADEPESQUISA() {
        if (linhadepesquisa == null) {
            linhadepesquisa = new ArrayList<LINHADEPESQUISA>();
        }
