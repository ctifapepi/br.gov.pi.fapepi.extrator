 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DADOS-BASICOS-DE-CURSOS-CURTA-DURACAO-MINISTRADO" minOccurs="0"/>
 *         &lt;element ref="{}DETALHAMENTO-DE-CURSOS-CURTA-DURACAO-MINISTRADO" minOccurs="0"/>
...
@XmlRootElement(name = "CURSO-DE-CURTA-DURACAO-MINISTRADO")
public class CURSODECURTADURACAOMINISTRADO {

    @XmlElement(name = "DADOS-BASICOS-DE-CURSOS-CURTA-DURACAO-MINISTRADO")
    protected DADOSBASICOSDECURSOSCURTADURACAOMINISTRADO dadosbasicosdecursoscurtaduracaoministrado;
    @XmlElement(name = "DETALHAMENTO-DE-CURSOS-CURTA-DURACAO-MINISTRADO")
    protected DETALHAMENTODECURSOSCURTADURACAOMINISTRADO detalhamentodecursoscurtaduracaoministrado;
    ...
    /**
     * Obtém o valor da propriedade dadosbasicosdecursoscurtaduracaoministrado.
     * 
     * @return
     *     possible object is
     *     {@link DADOSBASICOSDECURSOSCURTADURACAOMINISTRADO }
     *     
     */
    public DADOSBASICOSDECURSOSCURTADURACAOMINISTRADO getDADOSBASICOSDECURSOSCURTADURACAOMINISTRADO() {
        return dadosbasicosdecursoscurtaduracaoministrado;
    }

    /**
     * Define o valor da propriedade dadosbasicosdecursoscurtaduracaoministrado.
     * 
     * @param value
     *     allowed object is
     *     {@link DADOSBASICOSDECURSOSCURTADURACAOMINISTRADO }
     *     
     */
    public void setDADOSBASICOSDECURSOSCURTADURACAOMINISTRADO(DADOSBASICOSDECURSOSCURTADURACAOMINISTRADO value) {
        this.dadosbasicosdecursoscurtaduracaoministrado = value;
    }

    /**
     * Obtém o valor da propriedade detalhamentodecursoscurtaduracaoministrado.
     * 
     * @return
     *     possible object is
     *     {@link DETALHAMENTODECURSOSCURTADURACAOMINISTRADO }
     *     
     */
    public DETALHAMENTODECURSOSCURTADURACAOMINISTRADO getDETALHAMENTODECURSOSCURTADURACAOMINISTRADO() {
        return detalhamentodecursoscurtaduracaoministrado;
    }

    /**
     * Define o valor da propriedade detalhamentodecursoscurtaduracaoministrado.
     * 
     * @param value
     *     allowed object is
     *     {@link DETALHAMENTODECURSOSCURTADURACAOMINISTRADO }
     *     
     */
    public void setDETALHAMENTODECURSOSCURTADURACAOMINISTRADO(DETALHAMENTODECURSOSCURTADURACAOMINISTRADO value) {
        this.detalhamentodecursoscurtaduracaoministrado = value;
    }
